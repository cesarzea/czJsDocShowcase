 ...
 *
 */
Ext.define('czJsDocShowcase.view.abstractviewcontroller.eventmanager.EventManagerMediator', {
    singleton: true,
    mixins: ['Ext.mixin.Observable'],

    alias: 'eventManagerMediator',
    alternateClassName: 'eventManagerMediator',
